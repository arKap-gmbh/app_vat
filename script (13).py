...
print("✅ FIXED! Database loading now has 3 options:")
print("\n📁 Option 1: Auto-load from file path")
print("   • Put 'databaseaziendearkap.xlsx' in same folder as script")
print("   • Click 'Try Load from Path' button")
print(f"   • Current folder: {os.getcwd()}")
print("\n📤 Option 2: Manual upload")
print("   • Use the file uploader")
print("   • Select your .xlsx/.xls/.csv file")
print("\n⏭️ Option 3: Skip database")
print("   • Click 'Skip - Web Only'")
print("   • Continue with web extraction only")
print("\n🚀 Run: streamlit run arkap_vat_extractor_integrated.py")
